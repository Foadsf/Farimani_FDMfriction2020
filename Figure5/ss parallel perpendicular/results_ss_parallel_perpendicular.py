...
plt.figure(1)
plt.plot(D51,SF51,label = '51')
plt.plot(D87,SF87,label = '87g')
plt.plot(D135,SF135, label = '135g')
plt.plot(D195,SF195,label= '195g')
plt.plot(D243,SF243,label='243g')
