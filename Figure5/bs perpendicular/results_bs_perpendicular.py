...
dfa = pd.DataFrame({'a':[1,3,5,7,4,5,6,4,7,8,9],
                   'b':[3,5,6,2,4,6,7,8,7,8,9]})
print(dfa)

df1 = pd.read_excel('1700mm/1700mm_1800mm_min.xls',['48g','84g','132g','192g','240g'], header=1)
print(df1)  
SF52  = df1['48g']['Standard force'].iloc[1:]
SF88  = df1['84g']['Standard force'].iloc[1:]
SF136 = df1['132g']['Standard force'].iloc[1:]
SF196 = df1['192g']['Standard force'].iloc[1:]
SF244 = df1['240g']['Standard force'].iloc[1:]
#Standardforce = np.column_stack((SF51,SF87,SF135,SF195,SF243))
#print(Standardforce)
D52  = df1['48g']['Strain'].iloc[1:]
D88  = df1['84g']['Strain'].iloc[1:]
D136 = df1['132g']['Strain'].iloc[1:]
D196 = df1['192g']['Strain'].iloc[1:]
D244 = df1['240g']['Strain'].iloc[1:]
#print(Displacement)

plt.figure(1)
plt.plot(D52 ,SF52 ,label = '51g')
plt.plot(D88 ,SF88 ,label = '87g')
plt.plot(D136,SF136,label = '135g')
plt.plot(D196,SF196,label= '195g')
plt.plot(D244,SF244,label='243g')
...
plt.plot(Velocity2, BF44 ,'b', label= '49g')
plt.plot(Velocity2, BF80 ,'g', label= '85g')
plt.plot(Velocity2, BF128,'r', label= '133g')
plt.plot(Velocity2, BF188,'m', label= '192g')
plt.plot(Velocity2, BF236,'c', label= '241g')
...
p0 = [1, 0.55]
dr, cov = curve_fit(func, xdata, ydata,p0)
print(dr)
dr
np.array([1. , 1. ,0.67989058])
...
plt.xlabel('Weight (g)')
plt.show(8)      #varying speeds and surface areas, same orientation and about the same weihght
